...
DEFAULT_EMAIL_TEMPLATES: list[DefaultTemplate] = [
    DefaultTemplate(
        ...
        body=(
            ...
            "<p>"
            "Thank you for applying for <strong>{{job_title}}</strong> at {{company_name}}. "
    ...
    DefaultTemplate(
        ...
        body=(
            ...
            "{{company_name}}. After careful consideration, we've decided to move forward "
    ...
    DefaultTemplate(
        ...
        body=(
            ...
            "<strong>{{job_title}}</strong> at {{company_name}}."
            "</p>"
            "<p>"
            "Please review the attached offer letter and let us know if you have "
            "any questions. We look forward to welcoming you to the team."
            "</p>"
            "<br/>"
            "<p>"
            "Best regards,<br/>"
    ...
    DefaultTemplate(
        ...
        body=(
            "<p>Hi {{candidate_name}},</p>"
            "<p>"
            "I wanted to follow up on your application for the "
            "<strong>{{job_title}}</strong> position."
            "</p>"
            "<p>"
            "We're still reviewing candidates and will be in touch with next "
            "steps soon. Thank you for your patience."
            "</p>"
            "<br/>"
            "<p>"
            "Best regards,<br/>"
