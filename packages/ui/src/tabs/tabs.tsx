...
function TabsList({ ref, className, ...props }: React.ComponentProps<typeof TabsPrimitive.List> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
    <TabsPrimitive.List
      ref={ref}
...
function TabsTrigger({ ref, className, ...props }: React.ComponentProps<typeof TabsPrimitive.Trigger> & { ref?: React.Ref<HTMLButtonElement> }) {
  return (
...
function TabsContent({ ref, className, ...props }: React.ComponentProps<typeof TabsPrimitive.Content> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
