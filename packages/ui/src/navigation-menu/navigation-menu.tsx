...
function NavigationMenu({ ref, className, children, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Root> & { ref?: React.Ref<HTMLElement> }) {
  return (
...
function NavigationMenuList({ ref, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List> & { ref?: React.Ref<HTMLUListElement> }) {
...
function NavigationMenuTrigger({ ref, className, children, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Trigger> & { ref?: React.Ref<HTMLButtonElement> }) {
  return (
...
function NavigationMenuContent({ ref, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Content> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
...
function NavigationMenuViewport({ ref, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
...
function NavigationMenuIndicator({ ref, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Indicator> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
