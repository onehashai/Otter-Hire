...
function RadioGroup({ ref, className, ...props }: React.ComponentProps<typeof RadioGroupPrimitive.Root> & { ref?: React.Ref<HTMLDivElement> }) {
  return <RadioGroupPrimitive.Root className={cn("grid gap-2", className)} {...props} ref={ref} />;
}
RadioGroup.displayName = RadioGroupPrimitive.Root.displayName;

function RadioGroupItem({ ref, className, ...props }: React.ComponentProps<typeof RadioGroupPrimitive.Item> & { ref?: React.Ref<HTMLButtonElement> }) {
  return (
