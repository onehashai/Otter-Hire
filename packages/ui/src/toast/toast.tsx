...
function ToastViewport({ ref, className, ...props }: React.ComponentProps<typeof ToastPrimitives.Viewport> & { ref?: React.Ref<HTMLOListElement> }) {
  return (
...
function Toast({ ref, className, variant, ...props }: React.ComponentProps<typeof ToastPrimitives.Root> & VariantProps<typeof toastVariants> & { ref?: React.Ref<HTMLLIElement> }) {
  return <ToastPrimitives.Root ref={ref} className={cn(toastVariants({ variant }), className)} {...props} />;
}
Toast.displayName = ToastPrimitives.Root.displayName;

function ToastAction({ ref, className, ...props }: React.ComponentProps<typeof ToastPrimitives.Action> & { ref?: React.Ref<HTMLButtonElement> }) {
  return (
...
function ToastClose({ ref, className, ...props }: React.ComponentProps<typeof ToastPrimitives.Close> & { ref?: React.Ref<HTMLButtonElement> }) {
  return (
...
function ToastTitle({ ref, className, ...props }: React.ComponentProps<typeof ToastPrimitives.Title> & { ref?: React.Ref<HTMLDivElement> }) {
  return <ToastPrimitives.Title ref={ref} className={cn("text-sm font-semibold", className)} {...props} />;
}
ToastTitle.displayName = ToastPrimitives.Title.displayName;

function ToastDescription({ ref, className, ...props }: React.ComponentProps<typeof ToastPrimitives.Description> & { ref?: React.Ref<HTMLDivElement> }) {
