...
export const metadata: Metadata = {
  title: "Terms & Conditions — Otter",
  description: "Terms of service governing your use of Otter.",
};

const sections = [
  {
    title: "Acceptance of Terms",
    content: `Otter ("Otter", "We") provides its Service (as defined below) to you through its web site located at otter.bz (the "Site") and any related applications or APIs (together, the "Application"), subject to this Terms of Service agreement ("TOS").
...
Otter is an open-source Applicant Tracking System (ATS). The source code is available under its applicable open-source licence. Otter reserves the right to alter the Service at any time. Certain features of the Service may not be available in all countries.

The Service is provided on an "as-is" basis. That means the Service may include bugs that impact your ability to use the Service and/or may impact your business. Otter is not liable for your use of the Service.`,
  },
  {
    title: "General Conditions / Access and Use of the Service",
    content: `Otter is an open-source project. The source code is publicly available and licensed under the applicable open-source licence published in the repository. You may self-host, modify, and redistribute the code in accordance with that licence.
...
All rights, title, and interest in and to the Service and its components (excluding open-source components covered by their respective licences) remain with and belong exclusively to Otter.
...
Otter may collect information about your use of the Service ("Usage Data") for analytics purposes to review, analyse, and optimise the Service.`,
  },
  {
    title: "User Accounts",
...
Otter reserves the right to disable any user account at any time if, in our reasonable opinion, you have failed to comply with any of the provisions of this TOS.`,
  },
  {
    title: "Intellectual Property",
    content: `The Service and its original content (excluding Your Content and open-source components), features, and functionality are and will remain the exclusive property of Otter and its licensors. The Service is protected by copyright, trademark, and other laws of India and foreign countries.
...
You will not remove, alter, or obscure any copyright, trademark, service mark, or other proprietary rights notices incorporated in or accompanying the Service.`,
  },
  {
    ...
    content: `You represent and warrant to Otter that:
...
Otter reserves the right to (i) modify or discontinue, temporarily or permanently, the Service (or any part thereof) and (ii) refuse any and all current and future use of the Service, suspend or terminate your account, or remove any of Your Content in the Service for any reason, including if Otter believes that you have violated this TOS.

All of Your Content on the Service (if any) may be permanently deleted by Otter upon any termination of your account. Otter will use good-faith efforts to contact you prior to suspension or termination of your account.`,
  },
  {
...
Some jurisdictions do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the above limitations may not apply to you. In these jurisdictions, Otter's liability will be limited to the greatest extent permitted by law.`,
  },
  {
    title: "Indemnification",
    content: `You shall defend, indemnify, and hold harmless Otter from and against any claims, actions, or demands, including without limitation reasonable legal and accounting fees, arising or resulting from your breach of this TOS, any of Your Content, or your other access, contribution to, use, or misuse of the Service.

Otter shall provide notice to you of any such claim, suit, or demand. Otter reserves the right to assume the exclusive defence and control of any matter subject to indemnification under this section, in which case you agree to cooperate with any reasonable requests assisting Otter's defence of such matter.`,
  },
  {
    title: "Modifications",
    content: `Otter may change this TOS from time to time with at least 30 days' prior notice. The revised terms and conditions will be posted on the Service. If you use the Service within 30 days after the notice has been posted, your use will constitute acceptance of the revised terms. If any change to this TOS is not acceptable to you, your only remedy is to stop accessing and using the Service.`,
  },
  {
    title: "Assignment",
    content: `You may not assign this TOS without the prior written consent of Otter, but Otter may assign or transfer this TOS, in whole or in part, without restriction.`,
  },
  {
    title: "Governing Law",
    content: `This TOS shall be governed by and construed in accordance with the laws in force in India without regard to the principles of conflict of laws. Unless otherwise elected by Otter in a particular instance, you hereby expressly agree to submit to the exclusive personal jurisdiction of the courts in India for the purpose of resolving any dispute relating to your access to or use of the Service.`,
  },
  {
    title: "Arbitration",
...
The language of the arbitration shall be English. Each party shall bear its own attorney's fees and expenses, and fees of the arbitrator shall be borne equally by the parties.`,
  ...
  {
    title: "Privacy",
    content: `Please visit our Privacy Policy page to understand how Otter collects and uses personal information. By using the Service, you acknowledge and agree to the collection and use of your data as described in our Privacy Policy.`,
  },
  {
...
You shall not make Otter's Confidential Information available to any third party or use it for any purposes other than exercising your rights and performing your obligations under this TOS. This obligation survives termination of your use of the Service.`,
  },
  {
    title: "Notice",
    content: `You agree that Otter may communicate electronically with you for any matters relating to the Service, including product updates, legal notices, and account notifications, unless prohibited by law. Any notices to be provided to you under this TOS shall be sent by electronic mail to the last email address that we have on file for you.`,
  },
  {
    title: "Contact",
    ...
    <div className="marketing-root min-h-screen bg-white text-foreground">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="mb-12 rounded-2xl border border-black/8 bg-slate-50 p-6 text-sm leading-7 text-slate-600">
          Please read these Terms and Conditions carefully before using the Otter Service. By
