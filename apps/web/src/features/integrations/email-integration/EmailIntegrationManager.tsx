    ...
    <div className="space-y-4">
      <div className="w-full">
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          This address always receives inbound candidate emails directly. Connect forwarding below
          only if you want your existing mailbox to forward messages here automatically.
        </p>
      </div>
        ...
        <>
          ...
          {!isVerificationDone ? (
            ...
            <div className="text-xs text-green-600 font-medium">
              ...
              accept direct candidate emails as well.
            </div>
          )}
        </>
      ) : null}
