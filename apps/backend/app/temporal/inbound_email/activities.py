        ...
        async with AsyncSessionLocal() as session:
            ...
            for original_idx, resume_attachment in resume_attachments:
                ...
                if confidence < min_confidence:
                    logger.warning("Low resume confidence for %s (%s<%s)", resume_filename, confidence, min_confidence)
                    continue
                ...
                if current_job_id is not None and extracted_email and extracted_name:
                ...
                if current_job_id is not None:
                    ...
                    try:
                        from app.services.automation.execution import (
